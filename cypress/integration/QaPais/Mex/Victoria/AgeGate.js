...
describe("Validación Footer", () => {
  ...
  it("No comparta contenido con menores de edad", () => {
    cy.contains("NO COMPARTAS ESTE CONTENIDO CON MENORES DE EDAD", {
      matchCase: false,
    }).should("be.visible");
  });
  ...
  it("Todo con medida", () => {
    cy.get("span")
    .contains("TODO CON MEDIDA");
    // cy.contains("TODO CON MEDIDA")
    // .should("be.visible");
  });
  ...
  it("Contáctenos", () => {
    cy.get("a")
      .contains("Contáctanos", { matchCase: false })
      .should("be.visible")
      .and("have.attr", "href")
